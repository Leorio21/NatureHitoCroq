    ...
    <>
      ...
      <Container>
        ...
        <Paragraph>
          ...
          l&apos;alimentation les jouets ou les accessoires. Nous connaissons
          très bien le budget pour un animal que ce soit chien ou chat ou autre.
          La majorité de nos produits proposés sont testés soit par nous soit
          par des personnes proches de notre entourage.
        </Paragraph>
        <Paragraph>
          Certes nous sommes une petite animalerie mais nous ne désirons pas
          être comme les grosses animaleries et désolé du terme : devenir des
          vendeurs à l&apos;état pur. (vendre pour vendre , ce qui n&apos;est
          pas notre cas). Nous effectuons des combats journaliers pour éviter
          les augmentations que nous pouvons voir actuellement , pour rester
          dans de <strong>très bons rapport qualité prix</strong>. C&apos;est
          grâce à <strong>HITO</strong> qu&apos;aujourd&apos;hui que vous pouvez
          avoir une animalerie qui vous conseillera au mieux et vous pouvez
          aussi le remercier car de nouveaux produits sont testés par lui.
        </Paragraph>
        <Paragraph>
          Nous désirons aussi nous excuser, car étant un petit magasin nous ne
          pouvons pas tout avoir en stock, mais nous pouvons avoir sur commande
          en fonction des disponibilités.
        </Paragraph>
        <Paragraph>
          N&apos;hésitez pas à nous faire connaître nous resterons de taille
          humaine et resterons toujours dans notre optique : le{" "}
          <strong>bien-être</strong> en priorité pour nos{" "}
        ...
        <WordContainer>
          ...
          <WordDefinition>
            ...
            <Paragraph>
              ...
              vécu de grands moments et il m&apos;a développé des passions que
          ...
          <WordDefinition>
            ...
            <Paragraph>
              ...
              mais aussi croque pour croque la vie a pleine dent donc profitez
              de chaque moment.
            </Paragraph>
          </WordDefinition>
        </WordContainer>
